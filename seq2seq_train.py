...
tf.app.flags.DEFINE_integer('max_epochs', 100000, 'Maximum # of training epochs')
...
tf.app.flags.DEFINE_string('train_mode', 'scheduled_sampling', 'Decode helper to use for training')
